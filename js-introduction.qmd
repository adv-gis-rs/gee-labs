...
![Google Earth Engine code editor (source: Google Earth Engine [Developers Guide](https://developers.google.com/earth-engine/images/Playground_scripts.png)).](img/Code_editor_diagram.png)
...
![Save script to labs-gee repository.](img/save-js-intro-script.png)
